		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="{{ route('admin.home') }}">
					<img src="{{ asset('images/site') }}/{{ get_settings()->site_logo }}" alt="" class="dark-logo" />
					<img
						src="{{ asset('images/site') }}/{{ get_settings()->site_logo }}"alt=""class="light-logo"/>
				</a>
					...
					<ul id="accordion-menu">
						...
						<li>
							<a
								...
								<span class="mtext bi bi-">Profile</span>
							</a>
						</li>
                        <li>
							<a
								...
								<span class="mtext bi bi-">Setting</span>
							</a>
						</li>
                        <li>
							<a
								...
								<span class="micon  fi-braille"></span>
								<span class="mtext bi bi-">Categorie</span>
							</a>
						</li>
                        {{-- <li class="   {{ Route::is('admin.categorie.index') ?'active' :'' }}" >
							<a href="javascript:;" class="dropdown-toggle" data-option="off">
								<span class="micon  fi-braille"></span>
								<span class="mtext bi bi-">Categorie</span>
							</a>
							<ul class="submenu" style="display: block;">
								<li><a href="{{ route('admin.categorie.index') }}">index</a></li>
								<li><a href="{{ route('admin.categorie.create') }}">create</a></li>
